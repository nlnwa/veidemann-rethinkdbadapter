...
public class Upgrade1_13To1_14 extends UpgradeDbBase {
    public Upgrade1_13To1_14(String dbName, RethinkDbConnection conn) {
        super(dbName, conn);
    }
    ...
    final void upgrade() throws DbQueryException, DbConnectionException {
        ...
        // add default Crawl Host Group Config
